...
const CLASS_PATTERNS: ClassPattern[] = [
  ...
  // Spacing ([\w.]+ accepts named tokens like sm, md, 2xl alongside numeric values)
  ...
  { regex: /^space-x-([\w.]+)$/, category: "spacing", property: "spaceX", label: "Space X", extractValue: (m) => m[1] },
  { regex: /^space-y-([\w.]+)$/, category: "spacing", property: "spaceY", label: "Space Y", extractValue: (m) => m[1] },
